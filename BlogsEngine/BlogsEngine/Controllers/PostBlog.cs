...
namespace BlogsEngine.Controllers
{
    ...
    {
        private readonly ILogger<PostBlog> _logger;
        private readonly IBlogsService blogsService;
        private readonly IUsersService usersService;

        public PostBlog(ILogger<PostBlog> log, IBlogsService blogsService, IUsersService usersService)
        {
            _logger = log;
            ...
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "blogs")] HttpRequest req)
        {
            ...
            var result = blogsService.PostBlog(data);
